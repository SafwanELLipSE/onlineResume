...
import { faCircleUser, faPerson, faCalendarDays, faBook, faEyeDropper, faIdCard, faMosque, faRing, faAt, faSquarePhone, faAddressCard, faHouse, faAddressBook, faHouseChimney } from '@fortawesome/free-solid-svg-icons';
